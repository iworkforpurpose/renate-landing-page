...
export default function TalkToRecruiter() {
  return (
    <Section
      ...
      lede="Chat, text, or hop on a call — Renate responds, explains its reasoning, and acts. Adjust scoring mid-search, request a flag, approve an invite. Your recruiter is one message away."
      align="center"
